...
import TheProgram from "../images/theProgram.jpg"
...
export default function Home() {
  return (
    <div class=" ">
      <Layout>
        <div class="">
          <main class="lg:relative py-24 max-w-7xl mx-auto  ">
                ...
                <div class="">
                  <h1 class="text-4xl   tracking-tight font-extrabold text-gray-900 sm:text-5xl">
                    <span class="block xl:inline text-center">
                      Coding{" "}
                      <span class="text-sunset-500">for integration </span>
                    </span>
                  </h1>

                  <p class="mt-3  text-lg text-gray-500 sm:text-xl md:mt-5 text-left">
                    We aim at integrating refugees and vulnerable migrants using
                    a truly global language: coding. Through a free 7-months
                    programming course we give the necessary tools one needs to
                    enter the job market and develop a sustainable livelihood.
        ...
        <div class="bg-gray-50 bg-opacity-90 shadow">
            ...
            <div class="px-4 sm:px-6 sm:text-center  lg:col-span-6 lg:text-left lg:flex lg:items-center">
              <div>
                <h1 class="mt-4 text-4xl tracking-tight font-extrabold  sm:leading-none  lg:text-5xl ">
                  <span class=" md:block">
                    About{" "}
                    <span class="text-sunset-600 font-bold">the course</span>{" "}
                  </span>
                </h1>
                <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                  There are only 2 things you really need to join our course: to
                ...
                <div class="mt-3  inline-block mx-auto">
                  <button class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-l-full rounded-r-full text-white bg-sunset-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Apply
                  </button>
                </div>
                <div class="mt-3  inline-block mx-auto ml-3">
                  <a
                    href="mailto:rpereira@growin.com"
              ...
              <div class="-ml-36 sm:-ml-36 flex">
                ...
                >
                  <div class="absolute inset-0 flex flex-col items-center justify-center text-white">
                    <p class="text-4xl "> 1k+</p>
                    <p class="text-2xl text-center  ">Job Openings in Tech</p>
                  </div>
                </div>
                <div
                  style={{ borderRadius: "3rem" }}
                ...
                >
                  <div class="absolute inset-0 flex flex-col items-center justify-center text-white">
                    ...
                    <p class="text-2xl text-center  ">Students per Class</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class=" mx-auto max-w-7xl w-full text-center mt-4 ">
          <h1 class="text-4xl   tracking-tight font-extrabold text-gray-900 sm:text-5xl text-center">
            <span class="block xl:inline text-center">The Program</span>
          </h1>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
            daodkawodkawodkaopwdkawodkwaodwakdawod wdoawkdo kod
          </p>

          <div class="flex justify-center mt-10 px-10">
            <img class=" object-cover w-auto " src={TheProgram} alt=""></img>
          </div>
        </div>
        <div class="flex justify-center bg-gray-50  border-t-2  bg-opacity-70">
          <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <p class="inline text-3xl font-extrabold tracking-tight sm:block sm:text-4xl">
              Sign up <span class="text-sunset-600"> for our newsletter.</span>
            </p>
